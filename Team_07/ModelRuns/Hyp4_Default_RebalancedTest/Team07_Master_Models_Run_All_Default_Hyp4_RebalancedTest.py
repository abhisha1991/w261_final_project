...
def model_train_and_eval(data, splits, max_iter=1, model="logit", collect_metrics = True, rebalance_downsample=True, rebalance_downsample_test=True, custom_payload=None):
  '''
...
verbose = True
splits = get_timeseries_train_test_splits(data, train_test_ratio=2, test_months=6, start_year=2015, end_year=2019)
...
print(get_dates_from_splits(splits, 3, dtype="train"))
print(get_dates_from_splits(splits, 3, dtype="test"))
...
write_model_to_storage(storage_logit_results, "logit_h4ydrt_master")

display(read_model_from_storage("logit_h4ydrt_master"))
...
write_model_to_storage(storage_rf_results, "rf_h4ydrt_master")

display(read_model_from_storage("rf_h4ydrt_master"))
...
write_model_to_storage(storage_gbt_results, "gbt_h4ydrt_master")

display(read_model_from_storage("gbt_h4ydrt_master"))
...
write_model_to_storage(storage_svm_results, "svm_h4ydrt_master")

display(read_model_from_storage("svm_h4ydrt_master"))
