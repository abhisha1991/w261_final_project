...
write_model_to_storage(storage_logit_results, "logit_h4yd_master")

display(read_model_from_storage("logit_h4yd_master"))
...
write_model_to_storage(storage_rf_results, "rf_h4yd_master")

display(read_model_from_storage("rf_h4yd_master"))
...
write_model_to_storage(storage_gbt_results, "gbt_h4yd_master")

display(read_model_from_storage("gbt_h4yd_master"))
...
write_model_to_storage(storage_svm_results, "svm_h4yd_master")

display(read_model_from_storage("svm_h4yd_master"))
