...
# hyper param setting
custom_payload_logit["threshold"] = 0.35
custom_payload_logit["maxIter"] = 15
custom_payload_logit["regParam"] = 0.2
...
write_model_to_storage(storage_logit_results, "logit_h4yc2_master")

display(read_model_from_storage("logit_h4yc2_master"))
...
custom_payload_rf["minInstancesPerNode"] = 5
custom_payload_rf["minInfoGain"] = 0.05
...
write_model_to_storage(storage_rf_results, "rf_h4yc2_master")

display(read_model_from_storage("rf_h4yc2_master"))
...
custom_payload_gbt["maxDepth"] = 16
custom_payload_gbt["minInstancesPerNode"] = 5
custom_payload_gbt["minInfoGain"] = 0.05
...
write_model_to_storage(storage_gbt_results, "gbt_h4yc2_master")

display(read_model_from_storage("gbt_h4yc2_master"))
...
write_model_to_storage(storage_svm_results, "svm_h4yc2_master")

display(read_model_from_storage("svm_h4yc2_master"))
