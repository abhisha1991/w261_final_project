...
# hyper param setting
custom_payload_logit["threshold"] = 0.7
custom_payload_logit["maxIter"] = 15
custom_payload_logit["regParam"] = 0.9
...
write_model_to_storage(storage_logit_results, "logit_h4yc1_master")

display(read_model_from_storage("logit_h4yc1_master"))
...
desired_categorical_rf, desired_numeric_rf, cols_to_consider_rf, data_rf, custom_payload_rf = get_values_from_hypothesis(4)

# hyper param setting
custom_payload_rf["maxBins"] = 16
custom_payload_rf["numTrees"] = 30
custom_payload_rf["minInstancesPerNode"] = 20
custom_payload_rf["minInfoGain"] = 0.01
...
write_model_to_storage(storage_rf_results, "rf_h4yc1_master")

display(read_model_from_storage("rf_h4yc1_master"))
...
desired_categorical_gbt, desired_numeric_gbt, cols_to_consider_gbt, data_gbt, custom_payload_gbt = get_values_from_hypothesis(4)

# hyper param setting
custom_payload_gbt["maxBins"] = 16
custom_payload_gbt["maxDepth"] = 8
custom_payload_gbt["minInstancesPerNode"] = 20
custom_payload_gbt["minInfoGain"] = 0.01
custom_payload_gbt["maxIter"] = 15
custom_payload_gbt["stepSize"] = 0.2
...
write_model_to_storage(storage_gbt_results, "gbt_h4yc1_master")

display(read_model_from_storage("gbt_h4yc1_master"))
...
# hyper param setting
custom_payload_svm["maxIter"] = 50
custom_payload_svm["regParam"] = 0.5
custom_payload_svm["aggregationDepth"] = 4
custom_payload_svm["tol"] = 1e-04
custom_payload_svm["threshold"] = 0.0001
...
write_model_to_storage(storage_svm_results, "svm_h4yc1_master")

display(read_model_from_storage("svm_h4yc1_master"))
